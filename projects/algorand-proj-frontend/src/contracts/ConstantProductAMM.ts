...
export type ConstantProductAmmComposer<TReturns extends [...any[]] = []> = {
  ...
  * mint pool tokens given some amount of asset A and asset B.
   ...
   */
  simulate(): Promise<ConstantProductAmmComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<ConstantProductAmmComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<ConstantProductAmmComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
